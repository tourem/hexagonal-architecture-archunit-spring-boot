package com.larbotech.domain.model;
...
public class Activity {
	...
	public static class ActivityId {
		...
		private ActivityId(@NonNull final UUID id){
			this.id = id;
		}
		...
		public static ActivityId of(@NonNull final UUID id){
			return new ActivityId(id);
		}

		public static ActivityId ofString(final String id){
